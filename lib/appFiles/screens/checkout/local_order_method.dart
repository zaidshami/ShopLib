...
class local_order_method extends StatefulWidget {
  final bool? isModal;

  const local_order_method({this.isModal});

  @override
  BaseScreen<local_order_method> createState() => _CheckoutState();
}

class _CheckoutState extends BaseScreen<local_order_method> {
  int tabIndex = 0;
  Order? newOrder;
