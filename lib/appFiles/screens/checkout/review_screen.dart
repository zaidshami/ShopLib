              ...
              builder: (context, model, child) {
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      enabledShipping&&  orderMethod.runtimeType!=LocalOrder
                          ? ExpansionInfo(
            ...
            child: ButtonTheme(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  String localOrderData="";

                  if(orderMethod is LocalOrder){
                    localOrderData= (orderMethod as LocalOrder).localOrderMethod!.getType();
                    Provider.of<CartModel>(context, listen: false).address!.block=localOrderData;
                  }
