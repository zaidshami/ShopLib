...
import '../../models/index.dart' show CartModel, Order, ShippingMethodModel;
...
import 'widgets/local_address_screen.dart';
...
class _CheckoutState extends BaseScreen<Checkout> {
  ...
  void initState() {
   ...
   //   orderMethod.runtimeType==LocalOrder? await _loadShipping():"";
                  ...
                  child: Column(
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 13),
                        child: Text(
                          orderMethod.runtimeType==LocalOrder?
                          S.of(context).customerDetail.toUpperCase():    S.of(context).address.toUpperCase(),
                          style: TextStyle(
                              color: tabIndex == 0
                                  ? Theme.of(context).primaryColor
                                  : Theme.of(context).colorScheme.secondary,
        ...
        Scaffold(
          ...
          body: SafeArea(
            ...
            child: newOrder != null
                ...
                : Column(
                    children: <Widget>[
                      !isPayment ? (orderMethod.runtimeType==LocalOrder?LocalprogressBar:DeleverprogressBar) : const SizedBox(),
                      Expanded(
    ...
    switch (tabIndex) {
      case 0:
        return SizedBox(
          ...
          child: orderMethod.runtimeType==LocalOrder?LocalAddressScreen(onNext: ()
          {
            Future.delayed(Duration.zero, goToReviewTab);
      ...
      case 2:
        return SizedBox(
          ...
          child: ReviewScreen(onBack: () {
            orderMethod.runtimeType==LocalOrder?goToAddressTab(true): goToShippingTab(true);
          }, onNext: () {
            goToPaymentTab();
          }),
        );
  ...
  void goToReviewTab([bool isGoingBack = false]) {
    if (kPaymentConfig.enableReview) {
      ...
      if (isGoingBack) {
       // orderMethod.runtimeType==LocalOrder?goToAddressTab(): goToShippingTab(isGoingBack);
        goToShippingTab(isGoingBack);
      } else {
