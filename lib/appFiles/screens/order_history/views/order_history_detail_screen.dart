              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(getTitleStatus(
                        (order.status == OrderStatus.unknown &&
                            order.orderStatus != null
                            ? order.orderStatus
                            : order.status!.content)!, context),
             ...
             // if (order.status != null)
              ...
              if (order.billing != null) ...[
                ...
                Text(
                  ...
                  '${(order.billing!.street?.isEmpty ?? true) ? '' : '${order.billing!.street} '} \n'
                  '${(order.billing!.block?.isEmpty ?? true) ? '' : '${order.billing!.block} '}'
                  '${(order.billing!.city?.isEmpty ?? true) ? '' :
      '${((order.billing!.block!.isNotEmpty&&order.billing!.block!.contains("محلي"))?("رقم الطاولة: "+order.billing!.city!):order.billing!.city)} '}'
                 ,
                  //
                  ...
                  //     ' ${order.billing!.block}, '}${order.billing!.street!}, ${order.billing!.city!},'
                  //     ' ${getCountryName(order.billing!.country)}',
                ),
              ],
