...
class PriceTools {
  ...
  static String? getCurrencyFormatted(price, Map<String, dynamic>? rates,
    ...
    print("53536isssss errror curreny1"+currency.toString());
    ...
    try {
      ...
      print("isssss errror curreny4"+rates.toString());

      if (rates != null && rates[defaultCurrency.currencyCode] != null) {
        print("isssss errror curreny3");
