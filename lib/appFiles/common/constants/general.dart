...
class SettingConstants {
  static String aboutUsUrl = serverConfig['url']+'index.php?route=information/information&information_id=4';
  static String privecy = 'index.php?route=information/information&information_id=3';
  static String returnurl = 'index.php?route=information/information&information_id=3';
  static String supporturl = 'index.php?route=information/information&information_id=3';
  static String downloadurl = 'index.php?route=information/information&information_id=3';
