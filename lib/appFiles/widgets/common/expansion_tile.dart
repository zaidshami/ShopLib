...
class ConfigurableExpansionTile extends StatefulWidget {
  ...
  @override
  State<ConfigurableExpansionTile> createState() =>
...
class _ConfigurableExpansionTileState extends State<ConfigurableExpansionTile>
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    var borderSideColor = _borderColor.value ?? widget.borderColorStart;
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      RotationTransition(
                        turns: _iconTurns,
                        child:
                            widget.animatedWidgetPrecedingHeader ?? const SizedBox(),
                      ),
                      _getHeader(),
                      RotationTransition(
                        turns: _iconTurns,
                        child:
                            widget.animatedWidgetFollowingHeader ?? const SizedBox(),
                      )
                    ],
                  ))),
          ClipRect(
