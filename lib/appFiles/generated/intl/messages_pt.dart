...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(attribute) => "Qualquer ${attribute}";

  static String m1(point) => "Seus pontos disponíveis: ${point}";

  static String m2(state) => "Adaptador Bluetooth é ${state}";

  static String m3(day) => "${day} dias atrás";

  static String m4(total) => "~${total} km";

  static String m5(timeLeft) => "Ends in ${timeLeft}";

  static String m6(captcha) => "Digite ${captcha} para confirmar:";

  static String m7(message) => "Erro: ${message}";

  static String m8(time) => "Expirando em ${time}";

  static String m9(total) => ">${total} km";

  static String m10(hour) => "${hour} horas atrás";
  ...
  static String m12(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m13(minute) => "${minute} minutos atrás";

  static String m14(month) => "${month} meses atrás";

  static String m15(itemCount) => "${itemCount} itens";

  static String m16(price) => "Opções totais: ${price}";

  static String m17(total) => "Qtd: ${total}";

  static String m18(percent) => "Desconto ${percent} %";

  static String m19(second) => "${second} segundos atrás";
  ...
  static String m22(total) => "${total} produtos";

  static String m23(date) => "Válido até ${date}";

  static String m24(message) => "Atenção: ${message}";

  static String m25(default_currency) =>
      "A moeda selecionada atualmente não está disponível para o recurso Wallet, altere-a para ${default_currency}";

  static String m26(length) => "Encontramos ${length} produtos";

  static String m27(week) => "Semana ${week}";

  static String m28(year) => "${year} anos atrás";

  static String m29(total) => "Você atribuiu o pedido nº${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "agreeWithPrivacy":
            MessageLookupByLibrary.simpleMessage("Acordo de Privacidade"),
        ...
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Coleções de Bolsas"),
        ...
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("Endereço para envio"),
        ...
        "chatListScreen":
            MessageLookupByLibrary.simpleMessage("Tela da lista de bate-papo"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Continuar com pagamento"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Continuar revisando"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Continuar envio"),
        ...
        "couponInvalid": MessageLookupByLibrary.simpleMessage(
            "O seu código de cupom é inválido."),
        "couponMsgSuccess": MessageLookupByLibrary.simpleMessage(
            "Parabéns! Código de cupom aplicado com sucesso"),
        "createAnAccount":
            MessageLookupByLibrary.simpleMessage("Crie uma conta"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("O campo Email é obrigatório"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("Assinatura de e-mail"),
        "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
            "Parece que você ainda não adicionou nenhum item ao carrinho. Comece a adicionar itens para concluir sua compra."),
        ...
        "emptyWishlistSubtitle": MessageLookupByLibrary.simpleMessage(
            "Toque em qualquer coração ao lado de um produto para salvar. Vamos mantê-los para você aqui!"),
        "enableVacationMode":
        ...
        "featureProducts":
            MessageLookupByLibrary.simpleMessage("Produtos Destacados"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("O campo Nome é obrigatório"),
        "firstRenewal":
        ...
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("Retornar ao envio"),
        "greaterDistance": m9,
        ...
        "invalidSMSCode": MessageLookupByLibrary.simpleMessage(
            "Código de verificação por SMS inválido"),
        ...
        "itsOrdered":
            MessageLookupByLibrary.simpleMessage("Seu pedido foi feito!"),
        ...
        "languageSuccess": MessageLookupByLibrary.simpleMessage(
            "O idioma foi atualizado corretamente"),
        ...
        "listMessages":
            MessageLookupByLibrary.simpleMessage("Listar Mensagens"),
        "loadFail": MessageLookupByLibrary.simpleMessage(
            "Falha no upload ... Clique para tentar novamente!"),
        ...
        "loginToYourAccount":
            MessageLookupByLibrary.simpleMessage("Tem uma conta? Acesse aqui"),
        ...
        "note": MessageLookupByLibrary.simpleMessage("Notas de pedidos"),
        ...
        "openMap": MessageLookupByLibrary.simpleMessage("MAPA ABERTO"),
        ...
        "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
            "Você pode verificar o status do seu pedido usando nosso recurso de status de entrega. Você receberá um e-mail de confirmação do pedido com os detalhes do pedido e um link para acompanhar seu progresso"),
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "Você pode fazer login na sua conta usando o email e a senha definidos acima. Na sua conta, você pode editar os dados do seu perfil, verificar o histórico de transações, editar a assinatura da newsletter"),
        ...
        "pleaseAgreeTerms":
            MessageLookupByLibrary.simpleMessage("Concorde com nossos termos"),
        ...
        "recentSearches":
            MessageLookupByLibrary.simpleMessage("Pesquisas Recentes"),
        "recentView":
            MessageLookupByLibrary.simpleMessage("Visto Recentemente"),
        ...
        "refundRequest":
            MessageLookupByLibrary.simpleMessage("Pedido de Reembolso"),
        "refundRequested":
        ...
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("Livre para carregar mais"),
        "remove": MessageLookupByLibrary.simpleMessage("Remover"),
        "removeFromWishList":
            MessageLookupByLibrary.simpleMessage("Remover para WishList"),
        "requestBooking":
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("Seu endereço foi salvo"),
        "saveForLater":
        ...
        "searchForItems":
            MessageLookupByLibrary.simpleMessage("Buscar produtos"),
        "searchInput": MessageLookupByLibrary.simpleMessage(
            "Digite a entrada no campo de pesquisa"),
        "searchOrderId":
            MessageLookupByLibrary.simpleMessage("Pesquisar ID do pedido ..."),
        "searchPlace":
            MessageLookupByLibrary.simpleMessage("Local de Pesquisa"),
        "searchingAddress":
            MessageLookupByLibrary.simpleMessage("Endereço de pesquisa"),
        "secondsAgo": m19,
        ...
        "selectTheColor":
            MessageLookupByLibrary.simpleMessage("Selecionar cor"),
        "selectThePoint":
            MessageLookupByLibrary.simpleMessage("Select the point"),
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("Selecionar quantidade"),
        "selectTheSize":
            MessageLookupByLibrary.simpleMessage("Selecionar tamanho"),
        ...
        "signInWithEmail":
            MessageLookupByLibrary.simpleMessage("Entrar com email"),
        ...
        "updateUserInfor":
            MessageLookupByLibrary.simpleMessage("Atualização do Perfil"),
        ...
        "youHaveBeenSaveAddressYourLocal": MessageLookupByLibrary.simpleMessage(
            "Você salvou o endereço em seu local"),
        "youHavePoints":
            MessageLookupByLibrary.simpleMessage("Você tem \$point de pontos"),
        ...
        "yourAddressExistYourLocal": MessageLookupByLibrary.simpleMessage(
            "Seu endereço existe no seu local"),
        "yourApplicationIsUnderReview": MessageLookupByLibrary.simpleMessage(
            "Sua inscrição está em análise."),
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("Carrinho vazio"),
        "yourBookingDetail":
