...
class S {
  ...
  String get TableNumberRequired {
    return Intl.message(
      'Table Number field is required',
      name: 'TableNumberRequired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Customer detail`
  String get forrewardpoints {
    return Intl.message(
      'Please fill the current fields to enter our reword points system',
      name: 'forrewardpoints',
      desc: '',
      args: [],
    );
  }
