...
class TabBarCustom extends StatelessWidget {
  ...
  Widget _buildTabBar(context) {
    ...
    final colorIcon = Theme.of(context).backgroundColor;//tabConfig.colorIcon ?? theme.colorScheme.secondary;
    final colorActiveIcon =Colors.white;//tabConfig.colorActiveIcon ?? theme.primaryColor;
      ...
      child: shouldHideTabBar
          ...
          : Container(
              ...
              decoration: BoxDecoration(
                  ...
                  //tabConfig.showFloating ? null : tabConfig.color ?? Theme.of(context).backgroundColor,
